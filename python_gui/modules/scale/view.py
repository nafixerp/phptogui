"""Scale Settings window."""
from __future__ import annotations
import customtkinter as ctk
from ...core.auth import AppSession
from ...core.db import Database
from .service import SCALE_KEYS, ScaleService


class ScaleView(ctk.CTkFrame):
    TITLE = "Scale Settings"

    def __init__(self, master, database: Database, session: AppSession):
        super().__init__(master, fg_color="transparent")
        self.service = ScaleService(database, session)
    ...
    def _save(self):
        try:
            ...
            self.status.configure(text=str(exc).splitlines()[0], text_color="#C0392B"); return
        self.status.configure(text="Saved.", text_color="#1E8449")
