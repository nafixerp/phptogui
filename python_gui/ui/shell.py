...
_MODULES: dict[str, str] = {
    ...
    "MDI_BARCODE_PROFIT": "python_gui.modules.barcode_profit.view:BarcodeProfitView",
    "MDI_MARKED_LIST": "python_gui.modules.marked_list.view:MarkedListView",
    "MDI_DIAMOND_STONE_STOCK": "python_gui.modules.diamond_stone_stock.view:DiamondStoneStockView",
    "MDI_COUNTER_ISSUE": "python_gui.modules.counter_issue.view:CounterIssueView",
    "MDI_REORDER": "python_gui.modules.reorder.view:ReorderView",
    "MDI_BARCODE_HISTORY": "python_gui.modules.barcode_history.view:BarcodeHistoryView",
    "MDI_STOCK_PERIOD_LEDGER": "python_gui.modules.stock_period_ledger.view:StockPeriodLedgerView",
    "MDI_STOCK_SUMMARY_COST_WISE": "python_gui.modules.stock_summary.view:StockSummaryCostWiseView",
    "MDI_STOCK_SUMMARY_RATE_WISE": "python_gui.modules.stock_summary.view:StockSummaryRateWiseView",
    ...
    "MDI_ORDER_RATE_FIX": "python_gui.modules.order_admin.view:OrderAdminView",
    "MDI_ORDER_BLOCK": "python_gui.modules.order_admin.view:OrderAdminView",
    "MDI_ORDER_PROCESS": "python_gui.modules.order_reports.view:OrderReportsView",
    "MDI_ORDER_RETURNS": "python_gui.modules.order_reports.view:OrderReportsView",
    "MDI_REFINERY_ANALYTICS": "python_gui.modules.refinery_report.view:RefineryReportView",
    "MDI_REPAIR_COMPLAINTS": "python_gui.modules.repair_complaints.view:RepairComplaintsView",
    "MDI_KURI_TYPE_MASTER": "python_gui.modules.kuri_type_master.view:KuriTypeMasterView",
    "MDI_PDC_REPORT": "python_gui.modules.pdc_report.view:PdcReportView",
    "MDI_SMITH_LOT_REPORT": "python_gui.modules.smith_lot_report.view:SmithLotReportView",
    "MDI_GOLD_LOAN": "python_gui.modules.gold_loan.view:GoldLoanView",
    "MDI_EINVOICE_REGISTER": "python_gui.modules.einvoice_register.view:EInvoiceRegisterView",
    "MDI_OUTSTANDING_TAX": "python_gui.modules.outstanding_tax.view:OutstandingTaxView",
    "MDI_TDS_REPORT": "python_gui.modules.tds_report.view:TdsReportView",
    "MDI_PURITY_CERTIFICATE": "python_gui.modules.purity_certificate.view:PurityCertificateView",
    "MDI_SCHEME_INTEREST": "python_gui.modules.kuri_reports.view:KuriReportsView",
    ...
    "MDI_GOLDSMITH_NEW_WORK": "python_gui.modules.goldsmith_newwork.view:GoldsmithNewWorkView",
    "MDI_ACCOUNTS_PDC_COLLECTION": "python_gui.modules.pdc_collection.view:PdcCollectionView",
    ...
    "MDI_RUFF_WORK": "python_gui.modules.ruff_work.view:RuffWorkView",
    "MDI_ACCOUNTS_AMT_WGT_TRANSFER": "python_gui.modules.amt_wgt_transfer.view:AmtWgtTransferView",
    "MDI_ACCOUNTS_RESTART_DATE": "python_gui.modules.account_restart_date.view:AccountRestartDateView",
    "MDI_ACCOUNTS_PAYMENT_CONFIRMATION": "python_gui.modules.payment_confirmation.view:PaymentConfirmationView",
    ...
    "MDI_SALESMAN_MASTER": "python_gui.modules.salesman_master.view:SalesmanMasterView",
    "MDI_STATES_ADDING": "python_gui.modules.states_master.view:StatesMasterView",
    ...
    "MDI_STOCK_OPENING_STOCK": "python_gui.modules.stock_period_ledger.view:StockPeriodLedgerView",
    "MDI_RATE_HISTORY": "python_gui.modules.misc_reports.view:MiscReportsView",
    "MDI_JEWLLERY_BOOK": "python_gui.modules.item_reports.view:ItemReportsView",
    "MDI_MC_PROFIT": "python_gui.modules.item_reports.view:ItemReportsView",
    "MDI_OTHER_ITEM_REPORTS": "python_gui.modules.other_items.view:OtherItemsView",
    "MDI_GOLDSMITH_TRANSACTIONS": "python_gui.modules.smith_book.view:SmithBookView",
    ...
    "MDI_POINT_CARD_POINTS_REPORT": "python_gui.modules.point_card_points.view:PointCardPointsView",
    ...
    "MDI_CUSTOMER_ANALYTICS": "python_gui.modules.party_outstanding.view:PartyOutstandingView",
